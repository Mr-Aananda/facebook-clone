...
<template>
    <div id="MainNav"
        class="fixed z-50 w-full flex items-center justify-between h-[56x] bg-white shadow-xl border-b"
    >
        <div id="NavLeft" class="flex items-center justify-start w-[260px]">
            ...
            <div class="flex items-center justify-center bg-[#Eff2f5] p-1 rounded-full h-[40px] ml-2">
                ...
                <input type="text"
                    class="lg:block hidden border-none p-0 bg-[#Eff2F5] placeholder-[#64646B] ring-0 focus:ring-0"
